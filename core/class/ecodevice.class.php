...
class ecodevice extends eqLogic {
  ...
  public function getUrl() {
    if ($this->getConfiguration('type', '') == 'carte') {
      ...
      return eqLogic::byId(substr($this->getLogicalId(), 0, strpos($this->getLogicalId(), "_")))->getUrl();
    }
  }
  ...
  public function preUpdate() {
    switch ($this->getConfiguration('type', '')) {
      ...
      case "teleinfo":
        ...
        break;
      case "compteur":
        if ($this->getIsEnable() && $this->getConfiguration('typecompteur') == "") {
